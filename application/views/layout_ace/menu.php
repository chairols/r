				...
				<!-- El menú -->
                                <ul class="nav nav-list">
                                    ...
                                    <li class="<?=($m1['active']==1)?"active open":""?>">
                                        <a href="<?=$m1['href']?>" <?=(count($m1['submenu'])>0)?"class='dropdown-toggle'":""?>>
                                            <i class="menu-icon <?=$m1['icono']?>"></i>
                                            <span class="menu-text"><?=$m1['titulo']?></span>
                                            <b class="arrow<?=(count($m1['submenu'])>0)?" fa fa-angle-down":""?>"></b>
                                        </a>
                                        <b class="arrow"></b>
                                        <?php if(count($m1['submenu']) > 0) { ?>
                                        <ul class="submenu">
                                            <?php foreach($m1['submenu'] as $m2) { ?>
                                            <li class="<?=($m2['active']==1)?"active open":""?>">
                                                <a href="<?=$m2['href']?>" class="dropdown-toggle">
                                                    <i class="menu-icon <?=$m2['icono']?>"></i>
                                                    <span class="menu-text"><?=$m2['titulo']?></span>
                                                    <b class="arrow<?=(count($m2['submenu'])>0)?" fa fa-angle-down":""?>"></b>
                                                </a>
                                                <b class="arrow"></b>
                                                ...
                                                <ul class="submenu">
                                                    ...
                                                    <li class="<?=($m3['active']==1)?"active":""?>">
                                                        <a href="<?=$m3['href']?>">
                                                            <i class="menu-icon <?=$m3['icono']?>"></i>
                                                            <span class="menu-text"><?=$m3['titulo']?></span>
                                                        </a>
                                                    </li>
                                                    <?php } ?>
                                                </ul>
